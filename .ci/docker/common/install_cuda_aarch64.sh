...
function install_124 {
  ...
  wget -q https://developer.download.nvidia.com/compute/cudnn/redist/cudnn/linux-sbsa/cudnn-linux-sbsa-9.5.1.17_cuda12-archive.tar.xz -O cudnn-linux-sbsa-9.5.1.17_cuda12-archive.tar.xz
  tar xf cudnn-linux-sbsa-9.5.1.17_cuda12-archive.tar.xz
  cp -a cudnn-linux-sbsa-9.5.1.17_cuda12-archive/include/* /usr/local/cuda/include/
  cp -a cudnn-linux-sbsa-9.5.1.17_cuda12-archive/lib/* /usr/local/cuda/lib64/
  cd ..
  rm -rf tmp_cudnn
